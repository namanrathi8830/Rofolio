...
const Blog: React.FC = () => {
  ...
  // Define a direct URL to the Framer blog page
  const directFramerUrl = "https://rofolio.framer.website/blog";
  ...
  return (
    <div className="blog-container" style={{ width: '100%', height: '100vh', position: 'relative' }}>
      <iframe 
        ref={iframeRef}
        src={iframeSrc}
        title="Blog"
